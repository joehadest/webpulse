...
const servicesFeatures: FeatureItem[] = [
  {
    ...
    icon: <Globe className="w-24 h-24 text-white/90" />,
  },
  {
    id: 2,
    title: "Apps",
    description: "Aplicativos para celular e web.",
    icon: <Smartphone className="w-24 h-24 text-gray-400" />,
  },
  {
    id: 3,
    title: "Sistemas",
    description: "Sistemas para gestão e controle do seu negócio.",
    icon: <Database className="w-24 h-24 text-white/80" />,
  },
  {
    id: 4,
    title: "Integrações",
    description: "Conecto sistemas e automatizo processos.",
    icon: <Code2 className="w-24 h-24 text-gray-500" />,
  },
  {
    id: 5,
    title: "Design",
    description: "Layout limpo e fácil de navegar.",
    icon: <Layout className="w-24 h-24 text-gray-400" />,
  },
  {
    id: 6,
    title: "Manutenção",
    description: "Ajustes e melhorias no que já existe.",
    icon: <Rocket className="w-24 h-24 text-white/90" />,
  },
];
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
        <div className="absolute top-[20%] left-[10%] w-72 h-72 bg-white/[0.06] rounded-full blur-[100px]" />
        <div className="absolute bottom-[20%] right-[10%] w-72 h-72 bg-gray-600/20 rounded-full blur-[100px]" />
      </div>
