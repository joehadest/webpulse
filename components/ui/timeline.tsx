...
export const Timeline = ({
  ...
  return (
    <div
      className="w-full bg-[#030303] font-sans md:px-10 border-t border-white/[0.05]"
      ref={containerRef}
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[#030303] flex items-center justify-center border border-white/10">
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              {item.url && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 mt-4 text-white/70 hover:text-white transition-colors text-sm md:text-base underline underline-offset-4"
                >
                  Visitar site
                  <svg
                    className="w-4 h-4"
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-gray-500 via-white/60 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
