...
const Navbar: React.FC = () => {
    ...
    return (
        <nav className={`fixed w-full top-0 z-50 transition-all duration-500 ${
                    ...
                    <div className="flex items-center justify-center sm:hidden z-50 absolute left-2">
                        ...
                        >
                            <div className="relative w-4 h-4 flex flex-col justify-center items-center">
                                ...
                                />
                                <span
                                    className={`block absolute h-0.5 w-4 bg-current transition-all duration-300 ease-in-out ${
            ...
            {/* Mobile menu overlay */}
            <div
                className={`sm:hidden fixed inset-0 bg-black/80 backdrop-blur-md transition-all duration-500 ${
            ...
            >
                {/* Mobile menu panel */}
                <div
                    className={`absolute right-0 top-0 w-80 h-full bg-gradient-to-b from-gray-900/95 via-gray-800/95 to-gray-900/95 backdrop-blur-xl shadow-2xl border-l border-gray-700/50 transform transition-transform duration-500 ease-in-out ${
