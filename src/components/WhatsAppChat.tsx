...
const WhatsAppChat = () => {
    ...
    const predefinedMessages = [
        ...
        {
            id: 10,
            text: "Quero um projeto personalizado com domínio próprio",
            icon: "🎯",
            response: "Perfeito! 🎯 Projetos personalizados são nossa especialidade!\n\n✨ **O que oferecemos:**\n• Site 100% personalizado com design exclusivo\n• Domínio próprio (.com.br, .com, etc.)\n• Hospedagem premium inclusa\n• Certificado SSL (site seguro)\n• Área administrativa completa\n• SEO otimizado para Google\n• Funcionalidades específicas para seu negócio\n\n💰 **Vantagens:**\n• Pagamento único (sem mensalidades)\n• Propriedade total do código\n• Design exclusivo para sua marca\n• Suporte técnico incluído\n• Treinamento de uso\n\n⏱️ **Prazo:** 15-30 dias úteis (dependendo da complexidade)\n\n🎯 **Processo:**\n1. Briefing detalhado do projeto\n2. Proposta comercial personalizada\n3. Aprovação e desenvolvimento\n4. Revisões e ajustes\n5. Lançamento e treinamento\n\nQuer que eu te conecte com nossa equipe para um orçamento personalizado? 😊"
        }
    ];
    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 w-12 h-12 sm:w-14 sm:h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 z-50 flex items-center justify-center group"
            ...
            {isOpen && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-end justify-end z-50 p-2 sm:p-4">
                    <div className="bg-white rounded-t-2xl sm:rounded-t-3xl shadow-2xl w-full max-w-sm sm:max-w-md h-[70vh] sm:h-[600px] flex flex-col animate-slide-up">
                        {/* Header do chat */}
