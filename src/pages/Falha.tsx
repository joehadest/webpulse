...
const Falha: React.FC = () => {
  const handleWhatsAppContact = () => {
    const message = encodeURIComponent("Olá! Tentei realizar o pagamento do Plano WebPulse mas não consegui. Podem me ajudar?");
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white p-4">
      <div className="bg-gray-800 rounded-2xl shadow-lg p-6 sm:p-8 max-w-lg w-full text-center">
        <div className="mb-4 sm:mb-6">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-red-400">Ops! Algo deu errado</h1>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
          ...
          <p className="text-base sm:text-lg leading-relaxed">
            Isso pode acontecer por diversos motivos, como problemas temporários com a operadora do cartão ou dados incorretos.
          </p>
          <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">
            Nossa equipe está aqui para te ajudar! Entre em contato conosco via WhatsApp.
          </p>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <Link 
            to="/services" 
            className="inline-block w-full px-4 sm:px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-white font-semibold transition duration-300 text-sm sm:text-base"
          >
            Tentar Novamente
          </Link>
