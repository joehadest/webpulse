        ...
        <div className="min-h-screen bg-white py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center animate-fade-in">
                    ...
                    <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto animate-slide-up animation-delay-200">
                ...
                <div className="mt-12 grid gap-8 md:grid-cols-3">
                    {services.map((service, index) => (
                        <div
                            key={index}
                            className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100 transform hover:scale-105 transition-all duration-300 animate-fade-in"
                        ...
                        >
                            ...
                            <div className="px-6 py-4 bg-gray-50">
                                <a
                                    href="/contact"
                                    className="block text-center w-full px-4 py-2 border border-transparent text-sm font-medium rounded-md text-red-600 bg-white hover:bg-gray-50 transition-all duration-300 border border-red-600 transform hover:scale-105"
                                >
                ...
                <div className="mt-16 text-center animate-fade-in animation-delay-400">
                    <h3 className="text-2xl font-bold text-red-600 mb-4 animate-slide-up">
                        Compromisso com a Qualidade
                    </h3>
                    <p className="text-gray-600 max-w-3xl mx-auto animate-slide-up animation-delay-200">
